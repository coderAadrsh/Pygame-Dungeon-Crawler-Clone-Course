...
# pygame.mixer.music.play(-1,0.0,5000) #play the music
...
#func for outputting text onto the screen
...
# #temprorary damage text
# damage_text=DamageText(30,400,"15",constants.RED)
...
resume_button=Button(constants.SCREEN_WIDTH//2-175,constants.SCREEN_HEIGHT//2-50,resume_img)
restart_button=Button(constants.SCREEN_WIDTH//2-175,constants.SCREEN_HEIGHT//2-150,restart_img)
...
while run:
  ...
  if start_game==False:
    ...
    if pause_game==True:
      #draw pause menu
      screen.fill(constants.MENU_BG)
      # draw_text("PAUSED",font,constants.WHITE,constants.SCREEN_WIDTH//2-60,constants.SCREEN_HEIGHT//2-150)
  ...
  for event in pygame.event.get():
    ...
    if event.type==pygame.KEYDOWN:
      ...
      if event.key==pygame.K_ESCAPE:
        pause_game=True
      # optional: save a screenshot when pressing F12
...
# Quit Pygame and exit the program after the loop ends
pygame.quit()
sys.exit()